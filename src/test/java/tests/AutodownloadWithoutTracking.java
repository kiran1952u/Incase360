...
//        element.click();
        ...
        wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[3]/div[1]/div/input"))).sendKeys("large_batch");
        Thread.sleep(2000);
        ...
        wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"layout-wrapper\"]/div[2]/div/div/div[2]/div/form/div/div[12]/button\n"))).click();
