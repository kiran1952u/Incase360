...
@Test
public class Bulk_upload_for_parent_notice_Express_type_Backup_Original {
    ...
    public void UserAction() throws InterruptedException {
        ...
        driver.findElement(By.xpath("//span[normalize-space()='User Action']")).click();
        Thread.sleep(3000);
        driver.findElement(By.xpath("//a[normalize-space()='CSV Upload']")).click();
        Thread.sleep(3000);
