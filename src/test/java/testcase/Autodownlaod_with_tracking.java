...
public class Autodownlaod_with_tracking {
...
//        element.click();
        ...
        WebElement inputField = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[3]/div[1]/div/input")));
        inputField.sendKeys("Test_auto_downlaod");
        Thread.sleep(2000); // Optional, but avoid using Thread.sleep

        WebElement clickElement = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[3]/div[2]/div[1]/span")));
        clickElement.click();
        wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div[2]/div[2]/div/div/div[2]/div/form/div/div[4]/div/div/div/div[1]/span"))).click();
        Thread.sleep(2000);
...
//        wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div[2]/div[2]/div/div/div[2]/div/form/div/div[5]/div/div/div/div[1]/span"))).click();
//        Thread.sleep(2000);
