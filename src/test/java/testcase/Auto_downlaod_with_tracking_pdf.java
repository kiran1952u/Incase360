...
public class Auto_downlaod_with_tracking_pdf {
    ...
    public void loginPage() throws InterruptedException {
        ...
        Thread.sleep(3000);
        driver.findElement(By.xpath("/html/body/div[1]/div[2]/div[1]/div/div/div[1]/div[2]/div/div/div/div/ul/li[13]/a/span")).click();
        Thread.sleep(3000);
        ...
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy-MM-dd'T'HH:mm"); // Correct format
