...
public class AutoDownlaod_withtracking_Express_notice {
    ...
    public void loginPage() throws InterruptedException {
        ...
        for (String batchName : batchNames) {
            ...
            WebElement noticeSearch = wait.until(ExpectedConditions.visibilityOfElementLocated(
                    By.cssSelector("input[placeholder='Search']")));
            noticeSearch.clear();
            noticeSearch.sendKeys("Express_make_op");
            wait.until(ExpectedConditions.elementToBeClickable(
                    By.xpath("/html/body/div[3]/div[2]/div/span"))).click();

            // Select Batch
            wait.until(ExpectedConditions.elementToBeClickable(By.xpath(
                    "/html/body/div[1]/div[2]/div[2]/div/div/div[2]/div/form/div/div[3]/div/div"))).click();
            ...
            WebElement batchOption = wait.until(ExpectedConditions.elementToBeClickable(By.xpath(batchXpath)));
            batchOption.click();
