...
public class Standard_notice_with_unique_notice_type {


    @Test(dataProvider = "userData")
    public void Addnewnotice(String noticeType, String noticeDescription) throws InterruptedException {
        // Generate a unique identifier
        String uniqueID = UUID.randomUUID().toString().substring(0, 8); // Use first 8 characters of UUID
        ...
        noticeTypeField.sendKeys(uniqueNoticeType); // Use the unique notice type
